...
class GatewayBase(LLMServiceComponentBase):
    ...
    def _initialize_history(self):
        ...
        try:
            return HistoryService(
                history_config, 
                identifier=self.gateway_id + "_history",
                do_llm_service_request=self.do_llm_service_request,
                do_embedding_service_request=self.do_embedding_service_request,
            )
